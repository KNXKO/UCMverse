        ...
        <div class="container-fluid mt-5">
            <div class="container flex-column d-flex align-items-center align-content-center">
                ...
                <form action="includes/signup.inc.php" method="POST">
                    <input class="mb-4 shadow-sm" type="text" name="name" id="name" placeholder="Meno" maxlength="15" minlength="3" required>
                    <input class="mb-4 ms-sm-2 shadow-sm" type="text" name="priezvisko" id="priezvisko" placeholder="Priezvisko" minlength="3"
                        maxlength="25" required>
                    <br>
                    <input class="mb-4 shadow-sm" type="email" name="email" id="email" placeholder="E-mail" maxlength="35" minlength="5" required>
                    <p class="fw-semibold c-darkgrey shadow-sm">Dátum narodenia</p>
                    <input type="date" class="mb-4 p-2 me-2 shadow-sm">
                    <br>
                    ...
                    <input class="mb-4 shadow-sm" type="password" name="password" id="password" placeholder="Heslo" required minlength="8"
                        maxlength="40">
                    <input class="mb-4 ms-sm-2 shadow-sm" type="password" name="password" id="passwordrpt" placeholder="Potvrdenie hesla" minlength="8"
                        required maxlength="40">
                    <br>
                    <a class="menu-list">
                        <button class="fw-semibold btn-submit px-4 shadow-sm  mb-4" type="submit">Zaregistrovať sa</button>
                    </a>
                </form>
                <?php
                    if (isset($_GET["error"])){
